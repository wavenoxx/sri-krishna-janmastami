...
set -e
cd "$(dirname "$0")"
cat src/part2_core.mjs src/part3b_gokulam.mjs src/part3_world.mjs src/part4_flow.mjs > /tmp/gokulam_app.mjs
node --check /tmp/gokulam_app.mjs
{ cat src/part1_head.html; cat /tmp/gokulam_app.mjs; printf '</script>\n</body>\n</html>\n'; } > index.html
